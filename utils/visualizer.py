...
class MapVisualizer():
    ...
    def __init__(self):
        ...
        self.sample_points = o3d.geometry.PointCloud()
    ...
    def update(self, scan, pose, mesh = None):
        ...
        self.update_view()
        self.pause_view()
        # self.vis.capture_screen_image(f"./record/kitti/frame{self.frame_num}.png", do_render=True)
    ...
    def _initialize_visualizer(self):
        ...
        self.vis.get_render_option().point_size = 4
    ...
    def _register_key_callbacks(self):
        ...
        self._register_key_callback(["W"], self._toggle_view)
