...
class SHINEConfig:
    def __init__(self):
        ...
        self.sor_nn: int = 5  # SOR neighborhood size
        ...
        # use distance based keyframe (only for KITTI)
        self.use_keyframe: bool = False
        ...
        self.normal_sampling_on: bool = False
        self.gaussian_sampling_on: bool = False
        self.sliding_window_on: bool = False
        ...
        self.predict_residual_sdf: bool = False
        ...
        # optimizer
        self.iters: int = 200
        self.batch_iters: int = 2000 # for global optimization at last frame.
        ...
        self.extra_training: bool = False
        ...
        self.clean_mesh_on: bool = False # clean mesh vertex not close to point cloud
        self.infer_bs: int = 4096
        
        self.save_map: bool = False # save the sdf map or not, the sdf would be saved in the intensity channel

        # initialization
        self.scale: float = 1.0 # then will scale world size to [-1,1] for kaolin octotree
    ...
    def load(self, config_file):
        ...
        self.min_z = config_args["process"]["min_z"]
        self.max_z = config_args["process"]["max_z"]
        ...
        self.normal_sampling_on = config_args["sampler"]["normal_sampling_on"]
        self.gaussian_sampling_on = config_args["sampler"]["gaussian_sampling_on"]
        self.sliding_window_on = config_args["sampler"]["sliding_window_on"]
        # label
        ...
        self.predict_residual_sdf = config_args["decoder"]["predict_residual_sdf"]
        ...
        #self.batch_iters = config_args["optimizer"]["batch_iters"]
        ...
        self.extra_training = config_args["optimizer"]["extra_training"]
        ...
        self.clean_mesh_on = config_args["eval"]["clean_mesh_on"]
